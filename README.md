...
Project Structure
----
The project includes structured five-year ratio calculations and a dashboard built in Excel. Key metrics analyzed include:
...
* Operating Cash Flow / Net Income (x)
* Operating Cash Flow Margin (%)
* Cash Conversion Ratio (x)
...
* Cash flow margins
* Earnings quality validation (CFO / Net Income)
* Revenue comparison (converted to billions)
* Directional trend indicators (improving, stabilizing, volatile, deteriorating)

The layout follows a financial storytelling structure:

Profitability → Cash Flow → Earnings Quality
...
Conclusion
---
The comparison highlights how business model structure materially influences financial performance. Netflix’s focused digital subscription model supports higher margin efficiency and improving cash translation, whereas Disney’s diversified, multinational entertainment ecosystem provides revenue scale but introduces operational complexity and capital intensity. The project emphasizes that assessing financial health requires moving beyond headline profits to evaluate sustainability through cash flow strength and earnings quality metrics.
